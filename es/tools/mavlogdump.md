...
### Como visualizar un log:
Podemos convertir un log desde el formato binario en que están almacenador (`.BIN`) a texto plano usando la herramienta `mavlogdump.py`:
